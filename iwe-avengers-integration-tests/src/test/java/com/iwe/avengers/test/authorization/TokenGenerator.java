...
public class TokenGenerator {
	...
	public String getToken() {
		...
		final String clientId = "6upjshd65ub3hea0ib1v9dq48r";
		final String userPoolId = "us-east-1_BSxE7iwuZ";
		...
		initiateAuthRequest.addAuthParametersEntry("USERNAME", "joaaoeu");
		...
		final InitiateAuthResult initiateAuthResult =
